...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/uQUIC/Ether-UI/master/install.sh)
```
...
```sh
VERSION=1.2.0 && bash <(curl -Ls "https://raw.githubusercontent.com/uQUIC/Ether-UI/$VERSION/install.sh") $VERSION
```
...
wget https://github.com/uQUIC/Ether-UI/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
**Step 2:** Clone the Project Repository:
   ...
   ```sh
   git clone https://github.com/uQUIC/Ether-UI.git
   cd x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/uQUIC/Ether-UI.svg)](https://starchart.cc/Etheray/Ether-UI)
